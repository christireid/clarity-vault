    ...
    <div className="flex h-screen">
      ...
      <aside className="flex w-64 flex-col border-r bg-background">
        ...
        <nav className="flex-1 space-y-1 p-4">
          <NavItem href="/prompts" icon="prompts">
            Prompts
          </NavItem>
          <NavItem href="/collections" icon="collections">
            Collections
          </NavItem>
          <NavItem href="/playground" icon="playground">
            Playground
          </NavItem>
          <NavItem href="/analytics" icon="analytics">
            Analytics
          </NavItem>
          <NavItem href="/evaluations" icon="evaluations">
            Evaluations
          </NavItem>
